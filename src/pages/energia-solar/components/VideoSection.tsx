...
const VideoSection: React.FC = () => {
  ...
  return (
    <section className="relative py-16 md:py-18 bg-background overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-primary-container/20 to-transparent" />
      <div
        className="absolute inset-0 opacity-[0.03]"
        style={{
          backgroundImage: `radial-gradient(rgba(9, 57, 129, 0.68) 1px, transparent 1px)`,
      ...
      <div className="container-max mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          <div className="order-2 lg:order-1 lg:sticky lg:top-32">
            <span className="text-[20px] font-bold tracking-[0.2em] uppercase text-secondary mb-4 block">
              ENTENDA O PROCESSO
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-4xl mb-4 md:mb-6 leading-tight font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
              {bullets.map((item) => {
                ...
                return (
                  <div
                    key={item.text}
                    className="flex items-center gap-3 bg-surface-container-low/50 p-3 rounded-lg border border-outline-variant/20"
                  >
                    <div className="w-9 h-9 bg-primary-container flex items-center justify-center rounded-lg flex-shrink-0">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-secondary text-primary font-bold text-xs uppercase tracking-wider px-8 py-4 rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2"
            >
              <Phone size={16} />
          ...
          <div className="order-1 lg:order-2">
            <div
              ...
              style={{
                boxShadow:
                  "0 0 0 1px rgba(249, 192, 61, 0.2), 0 0 40px rgba(249, 192, 61, 0.15), 0 25px 50px -12px rgba(0, 0, 0, 0.5)",
              }}
            >
              <div className="aspect-video bg-primary-container relative">
                {!isPlaying ? (
                  <>
                    <iframe
                      className="w-full h-full absolute inset-0 opacity-0 pointer-events-none"
                      src={`https://www.youtube.com/embed/${videoId}?enablejsapi=1`}
                      title="Energia Solar NPA"
                      loading="lazy"
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="w-20 h-20 md:w-24 md:h-24 bg-secondary/90 rounded-full flex items-center justify-center backdrop-blur-sm transition-all group-hover:bg-secondary group-hover:shadow-[0_0_60px_rgba(249,192,61,0.6)]">
                          <Play
                            size={36}
            ...
            <div className="mt-8 bg-gradient-to-r from-secondary/10 via-secondary/5 to-transparent border border-secondary/20 rounded-xl p-6">
              ...
              <button
                onClick={handleSimulate}
                className="w-full bg-secondary text-primary font-bold text-sm uppercase tracking-wider py-4 rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2"
              >
                <TrendingUp size={18} />
                Simular economia
              </button>
