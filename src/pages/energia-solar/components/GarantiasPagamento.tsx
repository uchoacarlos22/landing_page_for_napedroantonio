...
export const GarantiasPagamento: React.FC = () => {
  return (
    <section className="py-12 md:py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-slate-50/50 -skew-x-12 translate-x-1/2 pointer-events-none hidden md:block" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-start">
          ...
          <div>
            <div className="mb-8 md:mb-10">
              <span className="text-secondary font-black text-xs uppercase tracking-widest mb-3 md:mb-4 block">
                Padrão de Qualidade NPA
              </span>
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-primary mb-4 md:mb-6 leading-tight">
              ...
              {[
                {
                  ...
                  icon: <ShieldCheck size={24} md:size={28} className="text-secondary" />,
                },
                {
                  title: "10 Anos no Inversor",
                  desc: "Cobertura total contra defeitos de fabricação em inversores PHB On-Grid de última geração.",
                  icon: <Zap size={24} md:size={28} className="text-secondary" />,
                },
                {
                  title: "12 Anos na Estrutura",
                  desc: "Fixação em alumínio anodizado e aço inox, resistente a corrosão e ventos fortes.",
                  icon: <Building2 size={24} md:size={28} className="text-secondary" />,
                },
                {
                  title: "ART Responsável",
                  desc: "Todo projeto acompanha ART (Anotação de Responsabilidade Técnica) do engenharia responsável.",
                  icon: <FileCheck2 size={24} md:size={28} className="text-secondary" />,
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-3 md:gap-5 group">
                  <div className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 bg-slate-50 rounded-xl md:rounded-2xl flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all duration-300">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="bg-primary rounded-2xl md:rounded-[32px] p-6 md:p-8 lg:p-12 shadow-2xl relative overflow-hidden text-white">
            <div className="absolute top-0 right-0 p-4 md:p-8 opacity-10">
              <CreditCard size={80} md:size={120} />
            </div>

            <div className="relative z-10">
              <h3 className="text-xl md:text-3xl font-black mb-6 md:mb-8 flex items-center gap-3 md:gap-4">
                <Lock className="text-secondary" size={24} md:size={28} />
              ...
              <div className="space-y-4 md:space-y-8">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-6">
                  <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <span className="font-bold text-base md:text-lg">Kit Solar em 24x</span>
                  </div>
                  <p className="text-white/60 text-sm mb-3 md:mb-4">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-6">
                  <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <span className="font-bold text-base md:text-lg">Entrada + Saldo no Pix</span>
                  </div>
                  <p className="text-white/60 text-sm mb-3 md:mb-4">
                ...
                <div className="flex items-center gap-3 md:gap-4 pt-3 md:pt-4 border-t border-white/10">
                  <Calendar className="text-secondary" size={20} md:size={24} />
                  <div>
              ...
              <div className="mt-6 md:mt-10 bg-white/10 p-4 md:p-6 rounded-xl md:rounded-2xl flex flex-col items-center text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3 md:gap-4 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
